...
function() {
    ...
    i = window.requestAnimationFrame || window.webkitRequestAnimationFrame ||
    function(t) {
...
// 图片地址在此处更换  可换成你的图片
var assets = ['img/1.png', 'img/2.png', 'img/3.png', 'img/4.png', 'img/5.png', ];
...
Promise.all(assets).then(function(images) {
    ...
    document.getElementsByClassName('journal-reward')[0].addEventListener('click',
    function() {
        //随机飘动
